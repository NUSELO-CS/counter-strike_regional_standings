...
function initTeams( matches, events, rankingContext ) {
    ...
    function insertTeam( name, teamId, players, isForfeitMatch ) {
        ...
        team = new Team( rosterId, teamId, name, players, isForfeitMatch );
        teams.push( team );
        return team;
    }
...
class DataLoader
{
    ...
    loadData( versionTimestamp = -1, filename = '../data/matchdata.json', newMatches, newEvents, overrideTimeStamp )
    {
