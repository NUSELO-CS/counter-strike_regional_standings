...
const nthHighest = require('../../model/util/nth_highest');
...
function generateOutput( teams, regions = [0,1,2], strDate ){
    ...
    let liveFolder= `./predicted/${strDate}/`
...
function displayRankings( teams, regions = [0,1,2], strDate ) {
    ...
    output += formatLine( '_Event data for Regional Standings provided by LiquipediaDB_' );
